//Object Destructuring :- Basically in object destructuring we store keys of an objects in some vaiable and then access those keys from objects using these vaiables
